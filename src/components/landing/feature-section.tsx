...
const features = [
  {
    ...
    description:
      'A growing set of expressive UI bits designed for real product surfaces.',
  },
  {
    icon: Code2,
    title: 'Multi-framework snippets',
    description:
      'A foundation for React now, with room for HTML/CSS/JS and other framework examples.',
  },
  {
    icon: GitBranch,
    title: 'Built for contributors',
    description:
      'Simple registry metadata and category folders make additions easy to review.',
  },
  {
    icon: Layers3,
    title: 'Copy, customize, ship',
    description:
      'Readable source-first components with visual previews and practical tags.',
  },
];
        ...
        <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 text-base leading-7 text-muted">
              Prism Bits is organized around browsing, previewing, copying, and
              contributing UI components without hiding the implementation
              behind a heavy system.
            </p>
          </div>
